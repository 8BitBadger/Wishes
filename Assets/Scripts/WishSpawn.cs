...
using UnityEngine;
public class WishSpawn : MonoBehaviour
{
    public GameObject wish;      // Apple Object in Scene (Sprite)
    ...
    public void SpawnRandom()
    {
        ...
        Vector3 spawnPosition = Camera.main.ScreenToWorldPoint(new Vector3(Random.Range(0, Screen.width), Random.Range(600, Screen.height)/*, Camera.main.farClipPlane / 2*/));
        //Instantiation of the Apple Object
        Instantiate(wish, spawnPosition, Quaternion.identity);
    }
}